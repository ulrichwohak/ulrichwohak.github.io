...
[Andrew Goodman-Bacon](https://goodman-bacon.com), [Pedro Sant'Anna](https://pedrohcgs.github.io), and I have just posted a new working paper [Differences in Differences with a Continuous Treatment](http://brantlycallaway.com).  In the paper, we are interested in DID strategies when a treatment variable is multi-valued/continuous, and, in particular, trying to answer questions like:
